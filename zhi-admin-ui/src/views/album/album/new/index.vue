<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="albumList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="相册名" align="center" prop="albumName" />
      <el-table-column label="相册描述" align="center" prop="albumDesc" />
      <el-table-column label="相册封面" align="center" prop="albumCover" width="100">
          <template slot-scope="scope">
              <image-preview :src="scope.row.albumCover" :width="50" :height="50"/>
          </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="相册封面">
          <image-upload v-model="form.albumCover"/>
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('album/album/export', {
        ...this.queryParams
